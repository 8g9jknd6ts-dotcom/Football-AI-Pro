...
- Corrected handicap research wording: a market structure that supports a narrow one-goal home win must be labelled “让平倾向”, not “让负”; “让负倾向” is reserved for evidence of an away win by two or more goals, while genuinely indistinguishable cases use “不设盘面方向”. This research label remains separate from the formal `HANDICAP_DECISION=SKIP` gate.
